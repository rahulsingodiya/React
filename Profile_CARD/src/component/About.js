...
const About = () => {
    return (
        <div className="card-section card-about is-active">
            ...
            <div class="card-social">
                ...
                <a href="#"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M377 0H135C60.562 0 0 60.563 0 135v242c0 74.438 60.563 135 135 135h242c74.438 0 135-60.563 135-135V135C512 60.562 451.437 0 377 0zm45 332c0 49.625-40.375 90-90 90H180c-49.625 0-90-40.375-90-90V180c0-49.625 40.375-90 90-90h152c49.625 0 90 40.375 90 90zm0 0"></path>
                </svg></a>
                <a href="#"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
